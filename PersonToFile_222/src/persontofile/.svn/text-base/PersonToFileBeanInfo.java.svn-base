 ...
 * @author nau
 */
public class PersonToFileBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( persontofile.PersonToFile.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int METHOD_main0 = 0;
    private static final int METHOD_PrintList1 = 1;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_main0] = new MethodDescriptor(persontofile.PersonToFile.class.getMethod("main", new Class[] {java.lang.String[].class})); // NOI18N
            methods[METHOD_main0].setDisplayName ( "" );
            methods[METHOD_PrintList1] = new MethodDescriptor(persontofile.PersonToFile.class.getMethod("PrintList", new Class[] {persontofile.PList.class})); // NOI18N
            methods[METHOD_PrintList1].setDisplayName ( "" );
        }
