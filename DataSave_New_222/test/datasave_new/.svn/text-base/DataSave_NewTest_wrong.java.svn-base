...
//public class DataSave_NewTest_wrong
//
//{
//    private IDS ds;
//    private PList pl;
...
//    {
//        IDS ds_xml = new DS_XML();
//        IDS ds_txt = new DS_TXT();
//        IDS ds_db = new DS_DB();
//        IDS ds_m = new DS_Mock();
//        
//        
...
//    }
//    public DataSave_NewTest_wrong(IDS ds, PList pl)
//    {
//        this.ds=ds;
//        this.pl=pl;
//    }
